...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '<li ng-repeat="item in pageList track by $index" ng-class="{d_color: item == conf.currentPage, separate: item == \'...\'}" ' +
            ...
            function getPagination(){
                ...
                if(scope.conf.rememberPerPage){
                    if(!parseInt(localStorage[scope.conf.rememberPerPage])){
                        ...
                        console.info("-----"+localStorage[scope.conf.rememberPerPage])
                    }

                    scope.conf.itemsPerPage = parseInt(localStorage[scope.conf.rememberPerPage]);
                  //  console.info("-&&&&-"+scope.conf.itemsPerPage)
                ...
                /**
                 * 2015-9-9 10:45:38 cmq  bug修复
                 * currentPage 被永久置为 0。将 L80~L82 同 L84~L87 这两块代码的顺序有问题，颠倒之后就正常了。
                 */
